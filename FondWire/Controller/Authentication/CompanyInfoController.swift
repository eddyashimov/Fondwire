...
//        }
        ...
        tableView.backgroundColor = .fwDarkBlueFg
...
//                    let companyExists = assets.contains { $0.name == companyName }
                    ...
                    let companyExists = assets.contains { asset in
                        if asset.name == companyName {
                            print("DEBUG: Found Asset \(asset.name)")
...
extension CompanyInfoController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.backgroundColor = .fwDarkBlueFg
    ...
    func tableView(_ tableView: UITableView, didDeselectRowAt indexPath: IndexPath) {
          if let cell = tableView.cellForRow(at: indexPath) {
                cell.contentView.backgroundColor = UIColor.fwDarkBlueFg
              }
    }
