...
//                }
    ...
    func configureUI() {
        ...
        iAgreeView.backgroundColor = .fwDarkBlueFg
        ...
        iConfirmView.backgroundColor = .fwDarkBlueFg
    ...
    @objc func switchValueDidChange(_ sender: UISwitch) {
        if iAgreeSwitch.isOn && iConfirmSwitch.isOn {
            ...
            self.continueButton.backgroundColor = .fwCyan
            }
        } else {
            UIView.animate(withDuration: 0.5) {
