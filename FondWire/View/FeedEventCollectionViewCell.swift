...
class FeedEventCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        eventLabel.anchor(top: topAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 20, paddingLeft: 15, paddingRight: 15)
        ...
        titleLabel.anchor(top: nameAndDateStack.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 15, paddingLeft: 15, paddingRight: 15)
        ...
        bodyStack.anchor(top: titleLabel.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 15, paddingLeft: 15, paddingRight: 15)
        
        let actionStack = UIStackView(arrangedSubviews: [interestedButton, dismissButton])
        actionStack.axis = .horizontal
        actionStack.spacing = 20
        addSubview(actionStack)
        actionStack.anchor(top: bodyStack.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 15, paddingLeft: 20, paddingRight: 15)
    }
    ...
    func configure()  {
        ...
        feedTextView.setHTMLFromString(htmlText: feedViewModel.bodyTxt!)
