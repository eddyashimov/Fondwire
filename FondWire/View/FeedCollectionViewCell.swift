...
//           set (newFrame) {
//              var frame = newFrame
//            let newWidth = frame.width * 2// get 90% width here
...
//            playerView.removeFromSuperview()
    ...
    override init(frame: CGRect) {
        ...
        archiveButton.anchor(top: feedTextView.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 15, paddingLeft: 15, paddingRight: 15)
